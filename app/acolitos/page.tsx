...
export default function AcolitosPage() {
  ...
  return (
    <>
      ...
      {/* Uso do MainLayout Centralizado */}
      <MainLayout userProfile={userRole} onLogout={handleLogout}>
          <main className="px-4 py-8 max-w-7xl mx-auto w-full pt-20 lg:pt-8 animate-in fade-in duration-500">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 items-start">
                ...
                {/* Coluna Esquerda: Busca, Botão e Lista */}
                        ...
                        {canManage && (
                            <div className="flex gap-2 w-full sm:w-auto">
                                ...
                                <button onClick={openNewForm} className="flex-1 sm:w-auto px-4 py-2.5 bg-blue-600 hover:bg-blue-700 text-white text-sm font-bold rounded-xl flex items-center justify-center gap-2 transition active:scale-95 shadow-md shadow-blue-600/20">
                                    <Plus size={18}/> <span className="hidden sm:inline">Novo</span><span className="sm:hidden">Novo</span>
                                </button>
                            </div>
                        )}
                    </div>
                ...
                {/* Coluna Direita: Sidebar de Aniversariantes */}
          ...
          {isFormOpen && (
            <div className="fixed inset-0 z-[100] bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 animate-in zoom-in-95">
               <div className="bg-white border border-gray-200 w-full max-w-2xl max-h-[90vh] overflow-y-auto rounded-3xl shadow-2xl flex flex-col relative custom-scrollbar">
